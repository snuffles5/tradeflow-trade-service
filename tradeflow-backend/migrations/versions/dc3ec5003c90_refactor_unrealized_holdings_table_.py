...
def upgrade():
    ...
    op.add_column('unrealized_holdings', sa.Column('net_quantity', sa.Float(), nullable=False))
    op.add_column('unrealized_holdings', sa.Column('net_cost', sa.Float(), nullable=False))
    op.add_column('unrealized_holdings', sa.Column('last_trade_price', sa.Float(), nullable=False))
    op.add_column('unrealized_holdings', sa.Column('holding_period_days', sa.Integer(), nullable=True))
    op.add_column('unrealized_holdings', sa.Column('updated_at', sa.DateTime(), nullable=False))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('unrealized_holdings', sa.Column('total_holding', mysql.FLOAT(), nullable=False))
