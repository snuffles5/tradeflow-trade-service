...
def upgrade():
    op.alter_column('trades', 'type', new_column_name='trade_type', existing_type=sa.String(length=20))


def downgrade():
    op.alter_column('trades', 'trade_type', new_column_name='type', existing_type=sa.String(length=20))
